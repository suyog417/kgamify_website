        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          />
            ...
            <div className="flex space-x-4">
              <Link href="https://www.linkedin.com/company/kgamify" rel="noopener noreferrer" target="_blank" className="text-gray-400 hover:text-white">
                <Linkedin size={20} />
              </Link>
              <Link href="https://www.instagram.com/kgamify/" rel="noopener noreferrer" target="_blank" className="text-gray-400 hover:text-white">
                <Instagram size={20} />
              </Link>
              <Link href="https://www.facebook.com/k.gamify" rel="noopener noreferrer" target="_blank" className="text-gray-400 hover:text-white">
                <Facebook size={20} />
              </Link>
              <Link
      href="https://x.com/kgamify"
    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col justify-between border-t border-gray-800 pt-8 text-gray-500 md:flex-row">
          <p>© 2025 Yantrikisoft. All rights reserved.</p>
