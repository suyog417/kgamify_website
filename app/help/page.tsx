  ...
  const helpArticles: HelpArticle[] = [
    {
      ...
      content: <p>Looking to join kGamify? Follow these quick and easy steps to create your kGamify account and start your gamified learning journey today.
      <br />This guide will help you sign up and set up your profile in just a few minutes.
      <br />Step 1: Visit the kGamify website
      <br />Step 2: Click on 'Sign Up'
      <br />Step 3: Fill in your details
      <br />Step 4: Verify your email
      <br />Step 5: Complete your profile setup
      <br />Once you've completed these steps, you'll have full access to all kGamify features and can start participating in championships and earning rewards.</p>,
    ...
    },
    {
      ...
      <p>
        ...
        <strong> download and install the kGamify mobile app</strong> on your Android or iOS device.
        Whether you're using <em>Google Play</em> or the <em>App Store</em>, we’ll walk you through
        the process to start your gamified learning experience seamlessly.
      </p>
      ...
      <ol className="list-decimal ml-12">
        ...
        <li>Tap the search tab and enter <strong>kGamify</strong>.</li>
        <li>Select the official app from the search results.</li>
        <li>Tap the <strong>Get</strong> button and authenticate if prompted.</li>
        <li>Wait for the app to download and install on your device.</li>
        <li>Once installed, tap <strong>Open</strong> and sign up or log in.</li>
      </ol> */}
    
      <p>
        Now you’re all set to explore competitions, earn rewards, and level up your skills with
        <strong>kGamify</strong>!
      </p>
    </section>,
    ...
    },
    {
      ...
      category: "getting-started",
      content: <section><p><strong>Joining Your First Competition</strong></p><p>Everything you need to know about participating in kGamify competitions and challenges.</p><p><strong>Understanding Game Modes</strong><br />kGamify offers two types of game modes for championships:</p><p><strong>Quick Hit:</strong> Perfect for practice sessions where you can familiarize yourself with the format and questions without any pressure.</p><p><strong>Play and Win:</strong> The competitive mode where you can win actual prizes and rewards based on your performance.</p><p><strong>Championship Access</strong><br />Anyone can play any championship - there are no minimum qualification requirements. This means you can jump into any competition that interests you, regardless of your experience level.</p><p><strong>Important Rules</strong><br />You can play each championship only once, regardless of which game mode you choose. Make sure to decide whether you want to practice first with Quick Hit or go straight for the prizes with Play and Win.</p><p><strong>How to Start Playing</strong><br />Simply click on any championship that catches your interest. A popup will appear showing you the rules and details for that specific championship. Take time to read through the rules carefully, then click the 'Play' button at the bottom to start your championship experience.</p><p>Choose your game mode wisely and enjoy the competitive experience that kGamify has to offer!</p></section>,
