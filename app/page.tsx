...
export default function Home() {
  return (
    <>
      <Head>
        <title>kGamify | Compete. Learn. Win.</title>
        <meta
          name="description"
          content="kGamify turns learning into competition! Join quiz championships, earn rewards, and unlock real-world opportunities. Engage students with gamified education."
        />
        <meta
          name="keywords"
          content="kGamify, gamified learning, quiz competitions, student engagement, educational tournaments, earn rewards, gamification, edtech, kGamify app"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://kgamify.in/" />

        {/* Open Graph */}
        <meta property="og:title" content="kGamify | Compete. Learn. Win." />
        <meta
          property="og:description"
          content="Experience the future of learning with kGamify. Compete in live quizzes, climb leaderboards, and earn career rewards through gamification."
        />
        <meta property="og:url" content="https://kgamify.in/" />
        <meta property="og:site_name" content="kGamify" />
        <meta property="og:image" content="/landing_preview.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="kGamify - Compete. Learn. Win." />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="kGamify | Compete. Learn. Win." />
        <meta
          name="twitter:description"
          content="Gamify your learning journey with kGamify. Compete in quiz tournaments, win rewards, and unlock your potential."
        />
        <meta name="twitter:image" content="/landing_preview.png" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://kgamify.in/search?q={search_term_string}",
